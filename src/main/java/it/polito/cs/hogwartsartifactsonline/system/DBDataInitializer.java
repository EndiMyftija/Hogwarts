...
//        Notice how we don't need to call the save method for ALL the artifacts and then for all the
//        wizards. This is because he wa have put the attribute cascade type = persist and merge in the Wizard
//        class. This means that when we save a wizard, all of his artifacts will be saved automatically
//        as well.
    }
}
